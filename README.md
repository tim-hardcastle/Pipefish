...
<a href="https://go.dev/doc/install">
    <img src="https://img.shields.io/badge/Requires-Go_v._1.24+-cyan">
</a>
...
* While Pipefish is very dynamic (as illustrated in the previous two points) it is also very strongly typed, much more so than any mainstream dynamic language. A rich, expressive type system offeers you parameterized types, interfaces, clone types, and more.
