...
- [What is Charm and why?](#what-is-charm-and-why)
...
- [Standard types](#standard-types)
  ...
  - [string](#string)
- [Variables](#variables)
- [Comments and continuations](#comments-and-continuations)
...
- [Functions](#functions)
  ...
  - [Local constants and inner functions](#local-constants-and-inner-functions)
  - [this](#this)
  - [More about conditionals](#more-about-conditionals)
  - [Import](#import)
- [Recursion](#recursion)
- [struct](#struct)
- [with](#with)
...
- [Widening variable types](#widening-variable-types)
- [Overloading](#overloading)
- [Type conversion and reflection](#type-conversion-and-reflection)
- [Eval and serialization](#eval-and-serialization)
- [Error handling](#error-handling)
- [Embedded Go](#embedded-go)
- [Imperative programming](#imperative-programming)
  - [The cmd section](#the-cmd-section)
  - [Transactions](#transactions)
  - [Encapsulation](#encapsulation)
- [Communication between services: exec](#communication-between-services-exec)
- [File access](#file-access)
- [Service variables](#service-variables)
- [The hub](#the-hub)
  - [Housekeeping](#housekeeping)
  - [Errors: why, where, and trace](#errors-why-where-and-trace)
  - [As a server](#as-a-server)
  - [Talking to other programs](#talking-to-other-programs)
  - [Testing](#testing)
