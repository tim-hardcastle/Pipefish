...
The interpreter is quite capable of deciding for itself whether it is necessary to perform the evaluation, without the user putting `let` statements in the main body of their functions. (N.B: for “is” read “will be”.
