...
([Issue 2898](https://github.com/golang/vscode-go/raw/v0.41.4/golang/vscode-go#2898))
...
📣 [Remote attach debugging](https://github.com/golang/vscode-go/raw/v0.41.4/docs/debugging.md#connecting-to-headless-delve-with-target-specified-at-server-start-up) is now available via Delve's native DAP implementation with Delve v1.7.3 or newer. It is now the default with the [Go Nightly](https://github.com/golang/vscode-go/raw/v0.41.4/docs/nightly.md) and will become the default for the stable releases in mid 2022.
...
* [Go Explorer view](https://github.com/golang/vscode-go/raw/v0.41.4/docs/ui.md#go-explorer-view): it displays environment variables and information about tools used by the extension. ([Issue 2049](https://github.com/golang/vscode-go/issues/2049))
...
([CL 254137](https://github.com/golang/vscode-go/raw/v0.41.4/ https:/go-review.googlesource.com/c/vscode-go/+/254137))
...
CL [253600](https://github.com/golang/vscode-go/raw/v0.41.4/ https:/go-review.googlesource.com/c/vscode-go/+/253600),
[253602](https://github.com/golang/vscode-go/raw/v0.41.4/ https:/go-review.googlesource.com/c/vscode-go/+/253602))
...
* [Ben Wood @(benclarkwood)](https://github.com/golang/vscode-go/raw/v0.41.4/benclarkwood)
